    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Checkout(OrderModel model)
        {
            if (ModelState.IsValid)                                                // ***************************
            {
                ...
                {
                    SaveOrder(model, payment, userId); //11111111111
        ...
        private void SaveOrder(OrderModel model, Payment payment, string userId)
        {
            ...
            foreach (var item in model.CartModel.CartItems)
            {
                ...
                order.OrderItems.Add(orderitem);     //2222222222222222222222222
            }
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-ECA09KNTaes3IetV1JpkKpO1nL3pKrEo";                      //iyzico api bölgesi***********
            options.SecretKey = "sandbox-wDxAvfX3zjyNK0ZJvU7MFGl6zCcWSoB3";
            ...
            foreach (var item in model.CartModel.CartItems)
            {
                ...
                basketItem.Category1 = "Sebze";
                basketItem.ItemType = BasketItemType.PHYSICAL.ToString();
                // basketItem.Price = item.Price.ToString().Split(",")[0];  // hata düzelt***************************************************
        ...
        {
            var orders = _orderService.GetOrders(null);// var orders = _orderService.GetOrders(_userManager.GetUserId(User));
